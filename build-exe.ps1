...
Write-Host '==> Nota: o patch de icone no EXE via rcedit esta desativado neste ambiente porque corrompe o binario do pkg.'
Write-Host '==> O arquivo dist\\painel_slide.ico continua disponivel para atalho/instalador.'
